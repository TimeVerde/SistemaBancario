...
public class Armazenar {
	...
	public static void gerarClientes() {
		...
		clientes.put("611.770.469-03",
				new Cliente("Maya Yasmin Analu Foga�a", "611.770.469-03", "18.290.249-3", "17/02/1973", "Feminino",
						"Fernanda Nair Elisa", "Guilherme Edson Luiz Foga�a", "maya_yasmin_fogaca@hotmail.fr",
		...
		clientes.put("696.481.582-15",
				new Cliente("Nelson Gael Filipe da Silva", "696.481.582-15", "48.859.461-3", "07/04/1943", "Masculino",
						...
						"79906-750", "Rua Vicente Azambuja", "247", "Jardim Marambaia", "Ponta Por�", "MS",
		...
		clientes.put("604.550.601-42",
				new Cliente("Severino Elias Kevin Teixeira", "604.550.601-42", "28.729.501-1", "17/02/1949",
						"Masculino", "Bruna La�s Betina", "M�rcio Eduardo Renato Teixeira",
		...
		clientes.put("626.710.312-97",
				new Cliente("Enrico Carlos Marcos Rezende", "626.710.312-97", "44.136.868-2", "12/05/1963", "Masculino",
						...
						"68908-006", "Avenida Cid Borges de Santana", "296", "Infraero", "Macap�", "AP",
						"(96) 3966-6575", dataCadastro, dataCadastro,
						new ArrayList<String>(Arrays.asList("�timo banco!")), "Arthur", 0, "1202644-1", "7160"));

		clientes.put("224.065.248-92", new Cliente("Isadora Luana da Silva", "224.065.248-92", "15.287.453-7", "14/06/1945",
				"Feminino", "Fl�via Ana Malu", "Marcos Ricardo Pietro da Silva", "isadora-dasilva79@icloud.com",
				"74594-087", "Rua VF 15", "896", "Setor Alto do Vale", "Goi�nia", "GO", "(62) 2551-2421", dataCadastro,
	...
	public static void gerarEmpresas() {
		...
		empresas.put("92.845.777/0001-75",
				new Empresa("Sebasti�o Nathan Brito", "640.229.647-31", "22.244.255-4", "26/05/2004", "Masculino",
						"Cl�udia Jaqueline D�bora", "Thomas Cl�udio Diego Brito", "brito@hotmail.com.br", "09442-150",
						"Rua Jacauna", "200", "Itrapo�", "Ribeir�o Pires", "SP", "(11) 3820-8827",
						"Calebe e Bernardo Inform�tica ME", "92.845.777/0001-75", "238.172.352.142",
		...
		empresas.put("87.264.331/0001-17",
				new Empresa("Nicole Eliane Isabelly Campos", "849.710.362-96", "17.254.762-3", "24/03/1991", "Feminino",
						...
						"Rua Doutor Micaeli", "111", "Para�so", "Belo Horizonte", "MG", "(31) 3525-2621",
						"Jos� e Marli P�es e Doces Ltda", "87.264.331/0001-17", "677.632.099.360",
		...
		empresas.put("74.011.080/0001-17",
				new Empresa("Diogo Anthony Nathan Lima", "209.886.646-15", "34.339.762-6", "02/04/1996", "Masculino",
						...
						"Rua Agenor Ferreira Pinto", "873", "Zer�o", "Macap�", "AP", "(96) 2773-4069",
						"S�rgio e Manoel Telecomunica��es ME", "74.011.080/0001-17", "503.576.361.782",
						sergioManoelTelecomunicacoesME, "Arthur", 0, "1202644-1", "7160"));

		empresas.put("88.406.097/0001-88",
				new Empresa("Hugo Andr� Dias", "989.515.179-93", "15.441.318-5", "25/02/1990", "Masculino",
						"Sandra Sueli Malu", "Gael C�sar Dias", "hugo-dias73@policiapenal.com", "39401-448",
						"Rua Henriqueta Batista", "488", "Esplanada", "Montes Claros", "MG", "(38) 3592-1619",
						"Vit�ria e Benedita Limpeza ME", "88.406.097/0001-88", "654.177.483.571",
		...
		empresas.put("89.299.008/0001-04",
				new Empresa("Oliver Rodrigo Pedro Assis", "107.660.482-09", "16.680.050-8", "10/03/1952", "Masculino",
						...
						"74990-785", "Rua dos Palmitos", "446", "Retiro do Bosque", "Aparecida de Goi�nia", "GO",
						"(62) 3538-8860", "Jos� e Carlos Eduardo Marketing ME", "89.299.008/0001-04", "535.073.996.445",
